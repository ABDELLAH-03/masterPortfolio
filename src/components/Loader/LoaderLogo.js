...
class LogoLoader extends React.Component {
  render() {
    ...
    return (
      ...
      >
        {/* Hexagon paths (keeping these as they are) */}
        <path
          class="myHexagon"
        ...
        {/* REPLACED: New "AC" text - made bigger and centered */}
        <text
          x="220"
          y="130"
          fill={theme.body}
        ...
        .logo-text {
          opacity: 0;
          animation: fadein 1s linear forwards 2.5s;
        }
        
        .name-text {
          opacity: 0;
          animation: fadein 1.5s linear forwards 3s;
        }
